...
import com.shtoone.njshtw.fragment.pitchactivity.PitchOverProofFragment;
import com.shtoone.njshtw.fragment.pitchactivity.PitchProduceQueryFragment;
import com.shtoone.njshtw.fragment.pitchactivity.PitchStatisticFragment;
import com.shtoone.njshtw.fragment.waterstablityactivity.WaterStablityMaterialStatisticFragment;
import com.shtoone.njshtw.fragment.waterstablityactivity.WaterStablityOverProofFragment;
import com.shtoone.njshtw.fragment.waterstablityactivity.WaterStablityProduceQueryFragment;
 ...
 */
public class WaterStablityActivity extends BaseActivity{
    private static final String TAG = WaterStablityActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            mFragments[0] = WaterStablityProduceQueryFragment.newInstance();
            mFragments[1] = WaterStablityOverProofFragment.newInstance();
            mFragments[2] = WaterStablityMaterialStatisticFragment.newInstance();
            int showPosition = 0;
            loadMultipleRootFragment(R.id.fl_container_pitch_activity, showPosition, mFragments[0], mFragments[1], mFragments[2]);
        } else {
            mFragments[0] = findFragment(WaterStablityProduceQueryFragment.class);
            mFragments[1] = findFragment(WaterStablityOverProofFragment.class);
            mFragments[2] = findFragment(WaterStablityMaterialStatisticFragment.class);
        }
