...
import com.shtoone.njshtw.bean.BHZEquipment;
import com.shtoone.njshtw.bean.EquipmentAndTestTypeData;
import com.shtoone.njshtw.bean.LiQingEquipment;
...
public class DialogActivity extends BaseActivity implements View.OnClickListener, TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    private void initView() {
        ...
        rg_sw = (RadioGroup)findViewById(R.id.rg_sw_dialog);
        ...
        rg_sw.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int i) {

                if (i == R.id.rb_all_sw_dialog) {
                    mParametersData.cllx = "0";
                } else if (i == R.id.rb_not_swhandle_dialog) {
                    mParametersData.cllx = "1";
                } else if (i == R.id.rb_swhandled_dialog) {
                    mParametersData.cllx = "2";
                }else if (i == R.id.rb_swnotexamine_dialog) {
                    mParametersData.cllx = "3";
                }else if (i == R.id.rb_swexamine_dialog) {
                    mParametersData.cllx = "4";
                }
        ...
        switch (mParametersData.fromTo) {
            case ConstantsUtils.WATERSTABLITYFRAGMENT:
            ...
            case ConstantsUtils.WATERSTABLITYOVERPROOFFRAGMENT:
                rg_sw.setVisibility(View.VISIBLE);

                break;

        }

        if (mParametersData.cllx.equals("0")) {

          rg_sw.check(R.id.rb_all_sw_dialog);
        } else if (mParametersData.cllx.equals("1")) {
            rg_sw.check(R.id.rb_not_swhandle_dialog);
        } else if (mParametersData.cllx.equals("2")) {
            rg_sw.check(R.id.rb_swhandled_dialog);
        }else if (mParametersData.cllx.equals("3")) {
            rg_sw.check(R.id.rb_swnotexamine_dialog);
        }else if (mParametersData.cllx.equals("4")) {
            rg_sw.check(R.id.rb_swexamine_dialog);
        }
