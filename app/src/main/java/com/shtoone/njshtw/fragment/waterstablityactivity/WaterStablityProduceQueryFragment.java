...
import com.shtoone.njshtw.activity.ProduceQueryDetailActivity;
import com.shtoone.njshtw.activity.WaterStablityProduceQueryDetailActivity;
import com.shtoone.njshtw.adapter.OnItemClickListener;
import com.shtoone.njshtw.adapter.ProduceQueryFragmentRecyclerViewAdapter;
import com.shtoone.njshtw.adapter.WaterStablityProduceQueryFragmentRecyclerViewAdapter;
import com.shtoone.njshtw.bean.ParametersData;
import com.shtoone.njshtw.bean.ProduceQueryFragmentListData;
 ...
 */
public class WaterStablityProduceQueryFragment extends BaseLazyFragment {
    private static final String TAG = WaterStablityProduceQueryFragment.class.getSimpleName();
    private Toolbar                                              mToolbar;
    private PtrFrameLayout                                       mPtrFrameLayout;
    private RecyclerView                                         mRecyclerView;
    private WaterStablityProduceQueryFragmentRecyclerViewAdapter mAdapter;
    private WaterStablityProduceQueryData                        itemsData;
    private FloatingActionButton                                 fab;
    private boolean isRegistered = false;
    private PageStateLayout mPageStateLayout;
    private Gson mGson;
    private boolean isLoading;
    private List<WaterStablityProduceQueryData.DataEntity> listData;
    private ParametersData mParametersData;
    private LinearLayoutManager mLinearLayoutManager;
    private int lastVisibleItemPosition;
    private ScaleInAnimationAdapter mScaleInAnimationAdapter;

    public static WaterStablityProduceQueryFragment newInstance() {
        return new WaterStablityProduceQueryFragment();
    }
...
//        initToolbarMenu(mToolbar);
        ...
        //设置动画与适配器
        SlideInLeftAnimationAdapter mSlideInLeftAnimationAdapter = new SlideInLeftAnimationAdapter(mAdapter = new WaterStablityProduceQueryFragmentRecyclerViewAdapter(_mActivity, listData));
    ...
    public String createRefreshULR() {
        ...
        return URL.getSWProduceData(userGroupID, equipmentID,startDateTime, endDateTime, currentPage);
    }
    ...
    public void onRefreshSuccess(String response) {
        if (!TextUtils.isEmpty(response)) {
            ...
            if (jsonObject.optBoolean("success")) {
                itemsData = mGson.fromJson(response, WaterStablityProduceQueryData.class);
                if (null != itemsData) {
    ...
    private void jump2ProduceQueryDetailActivity(int position) {
        Intent intent = new Intent(_mActivity, WaterStablityProduceQueryDetailActivity.class);
        Bundle bundle = new Bundle();
