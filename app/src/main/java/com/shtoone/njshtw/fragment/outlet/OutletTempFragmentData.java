package com.shtoone.njshtw.fragment.outlet;
...
public class OutletTempFragmentData {
    ...
    public static class ChartBean {
        ...
        private String dlsylq;
        private String gxlq;

        public String getDlsylq() {
            return dlsylq;
        }

        public void setDlsylq(String dlsylq) {
            this.dlsylq = dlsylq;
        }

        public String getGxlq() {
            return gxlq;
        }

        public void setGxlq(String gxlq) {
            this.gxlq = gxlq;
        }
