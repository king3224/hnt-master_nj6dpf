...
import com.shtoone.njshtw.adapter.WaterStablityOverproofFragmentViewPagerAdapter;
 ...
 */
public class WaterStablityOverProofFragment extends BaseLazyFragment {
    private static final String TAG = WaterStablityOverProofFragment.class.getSimpleName();
    ...
    private View                                           view;
    private WaterStablityOverproofFragmentViewPagerAdapter mAdapter;


    public static WaterStablityOverProofFragment newInstance() {
        return new WaterStablityOverProofFragment();
    }
    ...
    private void initData() {
        ...
        mParametersData.fromTo = ConstantsUtils.WATERSTABLITYOVERPROOFFRAGMENT;
...
//        initToolbarMenu(mToolbar);
    ...
    private void setAdapter() {
        mViewPager.setAdapter(mAdapter = new WaterStablityOverproofFragmentViewPagerAdapter(getChildFragmentManager(), mParametersData));
    ...
    public void hideOrShowFab(EventData event) {
        if (event.position == ConstantsUtils.WATERSTABLITYOVERPROOFFRAGMENT) {
            fab.hide();
        } else if (event.position == ConstantsUtils.WATERSTABLITYOVERPROOFFRAGMENT) {
            fab.show();
        }
    }
