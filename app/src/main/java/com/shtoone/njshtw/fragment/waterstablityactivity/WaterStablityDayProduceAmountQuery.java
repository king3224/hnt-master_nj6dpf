...
import com.shtoone.njshtw.activity.DayProduceQueryDetailActivity;
import com.shtoone.njshtw.adapter.PitchDayProdeceRecyclerViewAdapter;
import com.shtoone.njshtw.bean.ParametersData;
import com.shtoone.njshtw.bean.PitchDayProdeceRecyclerViewItemData;
 ...
 */
public class WaterStablityDayProduceAmountQuery extends BaseFragment {
    private static final String TAG = WaterStablityDayProduceAmountQuery.class.getSimpleName();
    ...
    public static WaterStablityDayProduceAmountQuery newInstance(ParametersData mParametersData) {
        Bundle args = new Bundle();
        args.putSerializable(ConstantsUtils.PARAMETERS, mParametersData);
        WaterStablityDayProduceAmountQuery fragment = new WaterStablityDayProduceAmountQuery();
