...
import com.shtoone.njshtw.activity.PitchProduceQueryDetailActivity;
import com.shtoone.njshtw.adapter.OnItemClickListener;
import com.shtoone.njshtw.adapter.PitchProduceQueryFragmentRecyclerViewAdapter;
import com.shtoone.njshtw.bean.ParametersData;
import com.shtoone.njshtw.bean.PitchProduceQueryFragmentListData;
 ...
 */
public class WaterStablityProduceDataQuery extends BaseFragment {
    private static final String TAG = WaterStablityProduceDataQuery.class.getSimpleName();
    ...
    public static WaterStablityProduceDataQuery newInstance(ParametersData mParametersData) {
        Bundle args = new Bundle();
        args.putSerializable(ConstantsUtils.PARAMETERS, mParametersData);
        WaterStablityProduceDataQuery fragment = new WaterStablityProduceDataQuery();
