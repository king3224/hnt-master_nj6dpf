...
public class ConstantsUtils {
    ...
    public static final int PITCHFRAGMENT = 7;
    public static final int PITCHPRODUCEQUERYFRAGMENT=8;
    public static final int PRODUCEDATAQUERY= 9;
    public static final int PITCHOVERPROOFFRAGMENT= 10;
    public static final int PITCHSTATISTICFRAGMENT=11;
    public static final int PITCHMAINACTIVITY = 12;
    public static final int PRODUCESGDATAQUERY = 13;
    public static final int TANPUWENDUFRAGMENT=14;
    public static final int OUTLETTEMPERTURE=25;
    public static final int PAVESPEEDFRAGMENT=26;
    public static final int TANBUXIANCHANG=20;
    public static final int DEVICELOCATIONACTIVITY=17;
    ...
    public static final int WATERSTABLITYFRAGMENT = 30;
    public static final int WATERSTABLITYOVERPROOFFRAGMENT= 31;
}
