...
import com.shtoone.njshtw.utils.StringUtils;
 ...
 */
public class WaterStablityFragmentRecyclerViewAdapter extends RecyclerView.Adapter {

    private Context                                                    context;
    private Resources                                                  mResources;
    private WaterStablityFragmentRecyclerViewItemData                  itemData;
    private List<WaterStablityFragmentRecyclerViewItemData.DataEntity> item;
    private OnItemClickListener                                        mOnItemClickListener;
    private static final int view_type_item = 0;
    private static final int view_type_footer = 1;

    public WaterStablityFragmentRecyclerViewAdapter(Context context, WaterStablityFragmentRecyclerViewItemData itemData) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (itemData != null && itemData.isSuccess() && itemData.getData().size() > 0) {
            itemViewHolder itemViewHolder = (WaterStablityFragmentRecyclerViewAdapter.itemViewHolder) holder;
